...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_print_reg is
  ...
  signal \gtOp_carry__2_n_0\ : STD_LOGIC;
  signal \gtOp_carry__2_n_1\ : STD_LOGIC;
  signal \gtOp_carry__2_n_2\ : STD_LOGIC;
  signal \gtOp_carry__2_n_3\ : STD_LOGIC;
  signal \gtOp_carry__3_i_1_n_0\ : STD_LOGIC;
  signal \gtOp_carry__3_n_3\ : STD_LOGIC;
  ...
  signal \NLW_gtOp_carry__3_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
  signal \NLW_gtOp_carry__3_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  attribute COMPARATOR_THRESHOLD of \gtOp_carry__3\ : label is 11;
...
gtOp_carry: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => gtOp_carry_i_1_n_0,
      S(2) => gtOp_carry_i_2_n_0,
      S(1) => gtOp_carry_i_3_n_0,
      S(0) => gtOp_carry_i_4_n_0
    );
...
\gtOp_carry__3\: unisim.vcomponents.CARRY4
     port map (
      CI => \gtOp_carry__2_n_0\,
      CO(3 downto 1) => \NLW_gtOp_carry__3_CO_UNCONNECTED\(3 downto 1),
      CO(0) => \gtOp_carry__3_n_3\,
      CYINIT => '0',
      DI(3 downto 1) => B"000",
      DI(0) => count_reg(32),
      O(3 downto 0) => \NLW_gtOp_carry__3_O_UNCONNECTED\(3 downto 0),
      S(3 downto 1) => B"000",
      S(0) => \gtOp_carry__3_i_1_n_0\
    );
\gtOp_carry__3_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => count_reg(32),
      O => \gtOp_carry__3_i_1_n_0\
    );
