...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_print_reg is
  ...
  signal \gtOp__0_carry__0_i_6_n_0\ : STD_LOGIC;
  ...
  signal \gtOp__0_carry__1_i_6_n_0\ : STD_LOGIC;
  signal \gtOp__0_carry__1_i_7_n_0\ : STD_LOGIC;
  signal \gtOp__0_carry__1_i_8_n_0\ : STD_LOGIC;
  ...
  signal \gtOp__0_carry__2_i_7_n_0\ : STD_LOGIC;
  ...
  signal \gtOp__0_carry_i_8_n_0\ : STD_LOGIC;
  signal \gtOp__0_carry_i_9_n_0\ : STD_LOGIC;
  ...
  signal print : STD_LOGIC_VECTOR ( 79 downto 9 );
  signal \print[10]_i_1_n_0\ : STD_LOGIC;
  ...
  signal \rom[0]_1\ : STD_LOGIC_VECTOR ( 5 downto 1 );
  ...
  signal \NLW_state1_carry__5_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  ...
  attribute SOFT_HLUTNM of \curr[0]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \curr[1]_i_1\ : label is "soft_lutpair6";
  ...
  attribute SOFT_HLUTNM of \print[10]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \print[16]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \print[18]_i_1\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of \print[9]_i_1\ : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of \request[4]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \request[5]_i_2\ : label is "soft_lutpair5";
begin
...
\gtOp__0_carry\: unisim.vcomponents.CARRY4
     port map (
      ...
      DI(3) => \gtOp__0_carry_i_2_n_0\,
      DI(2) => \gtOp__0_carry_i_3_n_0\,
      DI(1) => \gtOp__0_carry_i_4_n_0\,
      DI(0) => \gtOp__0_carry_i_5_n_0\,
      O(3 downto 0) => \NLW_gtOp__0_carry_O_UNCONNECTED\(3 downto 0),
      S(3) => \gtOp__0_carry_i_6_n_0\,
      S(2) => \gtOp__0_carry_i_7_n_0\,
      S(1) => \gtOp__0_carry_i_8_n_0\,
      S(0) => \gtOp__0_carry_i_9_n_0\
    );
\gtOp__0_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      DI(3) => count_reg(17),
      DI(2) => '0',
      DI(1) => \gtOp__0_carry__0_i_1_n_0\,
      DI(0) => \gtOp__0_carry__0_i_2_n_0\,
      O(3 downto 0) => \NLW_gtOp__0_carry__0_O_UNCONNECTED\(3 downto 0),
      S(3) => \gtOp__0_carry__0_i_3_n_0\,
      S(2) => \gtOp__0_carry__0_i_4_n_0\,
      S(1) => \gtOp__0_carry__0_i_5_n_0\,
      S(0) => \gtOp__0_carry__0_i_6_n_0\
    );
...
\gtOp__0_carry__0_i_6\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\gtOp__0_carry__1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => \gtOp__0_carry__1_i_1_n_0\,
      DI(2) => \gtOp__0_carry__1_i_2_n_0\,
      DI(1) => \gtOp__0_carry__1_i_3_n_0\,
      DI(0) => \gtOp__0_carry__1_i_4_n_0\,
      O(3 downto 0) => \NLW_gtOp__0_carry__1_O_UNCONNECTED\(3 downto 0),
      S(3) => \gtOp__0_carry__1_i_5_n_0\,
      S(2) => \gtOp__0_carry__1_i_6_n_0\,
      S(1) => \gtOp__0_carry__1_i_7_n_0\,
      S(0) => \gtOp__0_carry__1_i_8_n_0\
    );
...
\gtOp__0_carry__1_i_6\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => count_reg(22),
      I1 => count_reg(23),
      O => \gtOp__0_carry__1_i_6_n_0\
    );
\gtOp__0_carry__1_i_7\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => count_reg(20),
      I1 => count_reg(21),
      O => \gtOp__0_carry__1_i_7_n_0\
    );
\gtOp__0_carry__1_i_8\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\gtOp__0_carry__2\: unisim.vcomponents.CARRY4
     port map (
      ...
      DI(0) => \gtOp__0_carry__2_i_3_n_0\,
      O(3 downto 0) => \NLW_gtOp__0_carry__2_O_UNCONNECTED\(3 downto 0),
      S(3) => \gtOp__0_carry__2_i_4_n_0\,
      S(2) => \gtOp__0_carry__2_i_5_n_0\,
      S(1) => \gtOp__0_carry__2_i_6_n_0\,
      S(0) => \gtOp__0_carry__2_i_7_n_0\
    );
...
\gtOp__0_carry__2_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\gtOp__0_carry__2_i_4\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\gtOp__0_carry__2_i_7\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\gtOp__0_carry_i_8\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => count_reg(5),
      I1 => count_reg(4),
      O => \gtOp__0_carry_i_8_n_0\
    );
\gtOp__0_carry_i_9\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\print[10]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"A2"
    )
        port map (
...
\state1_carry__5\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3 downto 2) => \NLW_state1_carry__5_CO_UNCONNECTED\(3 downto 2),
      ...
      S(3 downto 2) => B"00",
      S(1) => \state1_carry_i_1__5_n_0\,
      S(0) => \state1_carry_i_2__5_n_0\
    );
