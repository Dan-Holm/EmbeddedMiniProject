...
#set_property -dict { PACKAGE_PIN L15   IOSTANDARD LVCMOS33 } [get_ports { CS  }]; #IO_L22N_T3_AD7N_35 Sch=led4_b
...
#set_property -dict {PACKAGE_PIN M15 IOSTANDARD LVCMOS33} [get_ports CSLED]
...
#set_property -dict { PACKAGE_PIN V17   IOSTANDARD LVCMOS33 } [get_ports { GND }]; #IO_L21P_T3_DQS_34 Sch=ar[8]
...
#set_property -dict {PACKAGE_PIN N17 IOSTANDARD LVCMOS33} [get_ports VCC]
...
#set_property -dict { PACKAGE_PIN Y11   IOSTANDARD LVCMOS33 } [get_ports { CS }]; #IO_L18N_T2_13 Sch=a[0]
#set_property -dict { PACKAGE_PIN Y12   IOSTANDARD LVCMOS33 } [get_ports { MISO }]; #IO_L20P_T3_13 Sch=a[1]
#set_property -dict { PACKAGE_PIN W11   IOSTANDARD LVCMOS33 } [get_ports { SCLK }]; #IO_L18P_T2_13 Sch=a[2]
#set_property -dict { PACKAGE_PIN V11   IOSTANDARD LVCMOS33 } [get_ports { MOSI }]; #IO_L21P_T3_DQS_13 Sch=a[3]
#set_property -dict { PACKAGE_PIN T5    IOSTANDARD LVCMOS33 } [get_ports { VCC }]; #IO_L19P_T3_13 Sch=a[4]
#set_property -dict { PACKAGE_PIN U10   IOSTANDARD LVCMOS33 } [get_ports { GND }]; #IO_L12N_T1_MRCC_13 Sch=a[5]
